...
public class Sortings1 {
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            // 1.Bubble Sort: we'll make comparison to each adjacent element ,we'll run loop
            // till n-1 times.(Sorting in ascending order)

            for (int i = 0; i < Number.length - 1; i++) { // Outer loop for counter
                for (int j = 0; j < Number.length - i - 1; j++) { // -i-1 is for stopping,as after first loop one
                                                                  // element will be get sorted
